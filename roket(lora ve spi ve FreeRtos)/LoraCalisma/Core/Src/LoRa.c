...
//uint8_t LoRa_read(LoRa* _LoRa, uint8_t addr)
//{
//    uint8_t receivedData = 0;
//    uint8_t address = addr & 0x7F; // MSB = 0 --> Read mode
//
//    HAL_GPIO_WritePin(_LoRa->CS_port, _LoRa->CS_pin, GPIO_PIN_RESET); // CS low
//
//    HAL_SPI_Transmit(_LoRa->hSPIx, &address, 1, HAL_MAX_DELAY);
//    HAL_SPI_Receive(_LoRa->hSPIx, &receivedData, 1, HAL_MAX_DELAY);
//
//    HAL_GPIO_WritePin(_LoRa->CS_port, _LoRa->CS_pin, GPIO_PIN_SET);   // CS high
//
//    return receivedData;
//}
